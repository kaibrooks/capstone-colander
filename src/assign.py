...
def run_ga(mutationProbability, populationSize, eliteRatio, crossoverProbability, parentsPortion, verbose=1):
    ...
    print('Generations:', num_generations, 'Population:', populationSize, 'Mutation:', mutationProbability,
          'EliteR:', eliteRatio, 'CrossO:', crossoverProbability, 'ParentP:', parentsPortion)
